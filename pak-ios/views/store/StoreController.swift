...
class StoreController : UIViewController, UICollectionViewDelegate, UICollectionViewDataSource,NVActivityIndicatorViewable {
    ...
    func getCategories() {
        ...
        let params: Parameters = [ "IdUsuario": idUser]
